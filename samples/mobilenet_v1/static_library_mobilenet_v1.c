...
// An example to demonstrate how to run a MobileNet V1 model with IREE on
// bare-metal Arm.
//
...
mobilenet_v1_0_25_224_1_default_1_linked_llvm_cpu_library_query(
